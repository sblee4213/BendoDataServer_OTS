...
namespace bendodatasrv
{
    public sealed class USSocketServer
    {
        ...
        public void StartServer(int port)
        {
            ...
            Console.WriteLine("US Socket created");
            objLogger.LogWrite("US Socket created");
            ...
            Console.WriteLine("US Socket listening ... ");
            objLogger.LogWrite("US Socket listening ... ");
        ...
        private void handleClientConnectionRequest(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                Console.WriteLine("US Socket connected.");
                objLogger.LogWrite("US Socket connected");
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Error on waiting for RX: {0}", ex.Message);
                return;
            }
        }
        ...
        private void handleDataReceive(IAsyncResult ar)
        {
            ...
            {
                emsg = "Error on waiting for RX: " + ex.Message;
                // 예외가 발생하면 예외 정보 출력 후 함수를 종료한다.
                Console.WriteLine(emsg);
                objLogger.LogWrite(emsg);
                return;
        ...
        private void handleDataSend(IAsyncResult ar)
        {
            ...
            {
                // 예외가 발생하면 예외 정보 출력 후 함수를 종료한다.
                emsg = "Error on sending. err:" + ex.Message;
                Console.WriteLine(emsg);
                objLogger.LogWrite(emsg);
                return;
            }
